...
extension Order {
    static let mockDelivered = Order(
        ...
        items: [
            OrderItem(id: "OI-001", productId: "PRD-001", name: "Serta Upholstered Convertible Sofa", brand: "Serta", price: 649.99, quantity: 1, image: "sofa-1", selectedVariant: "Charcoal Gray"),
            OrderItem(id: "OI-002", productId: "PRD-003", name: "Brightech Sky LED Floor Lamp", brand: "Brightech", price: 54.99, quantity: 2, image: "lamp-1", selectedVariant: nil)
        ],
        subtotal: 759.97,
        shippingCost: 0,
        tax: 62.70,
    ...
    static let mockShipped = Order(
        ...
        items: [
            OrderItem(id: "OI-003", productId: "PRD-005", name: "nuLOOM Moroccan Blythe Area Rug", brand: "nuLOOM", price: 129.99, quantity: 1, image: "rug-1", selectedVariant: nil)
        ],
        subtotal: 129.99,
        shippingCost: 9.99,
        tax: 11.55,
    ...
    static let mockPlaced = Order(
        ...
        items: [
            OrderItem(id: "OI-004", productId: "PRD-013", name: "Delta Trinsic Pull-Down Kitchen Faucet", brand: "Delta", price: 329.99, quantity: 1, image: "faucet-1", selectedVariant: nil),
            OrderItem(id: "OI-005", productId: "PRD-015", name: "Kasa Smart Plug (4-Pack)", brand: "TP-Link", price: 22.99, quantity: 1, image: "plug-1", selectedVariant: nil)
        ],
        subtotal: 352.98,
        shippingCost: 0,
        tax: 29.12,
    ...
    static let mockProcessing = Order(
        ...
        items: [
            OrderItem(id: "OI-006", productId: "PRD-028", name: "KitchenAid Artisan Stand Mixer 5-Qt", brand: "KitchenAid", price: 449.99, quantity: 1, image: "mixer-1", selectedVariant: "Empire Red"),
            OrderItem(id: "OI-007", productId: "PRD-027", name: "Henckels Modernist 14-Piece Knife Block Set", brand: "Henckels", price: 149.99, quantity: 1, image: "knives-1", selectedVariant: nil)
        ],
        subtotal: 599.98,
        shippingCost: 0,
        tax: 49.50,
    ...
    static let mockCancelled = Order(
        ...
        items: [
            OrderItem(id: "OI-008", productId: "PRD-023", name: "UDPATIO 4-Piece Outdoor Conversation Set", brand: "UDPATIO", price: 349.99, quantity: 1, image: "patio-1", selectedVariant: "Dark Brown / Beige")
        ],
        subtotal: 349.99,
        shippingCost: 0,
        tax: 28.87,
