...
extension Product {
    ...
    static let mockSofa = Product(
        ...
        salePrice: 649.99,
        currency: "USD",
        images: [.init(url: "sofa-1", alt: "Serta sofa front view"), .init(url: "sofa-2", alt: "Serta sofa side view")],
    ...
    static let mockDiningTable = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "table-1", alt: "Farmhouse dining table")],
    ...
    static let mockBedFrame = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "bed-1", alt: "Platform bed frame")],
    ...
    static let mockBarStools = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "stool-1", alt: "Bar stools set")],
    ...
    static let mockDeskChair = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "chair-1", alt: "Ergonomic office chair")],
    ...
    static let mockBookshelf = Product(
        ...
        salePrice: 99.99,
        currency: "USD",
        images: [.init(url: "bookshelf-1", alt: "Industrial bookshelf")],
    ...
    static let mockSideTable = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "sidetable-1", alt: "Marble side table")],
    ...
    static let mockFloorLamp = Product(
        ...
        salePrice: 54.99,
        currency: "USD",
        images: [.init(url: "lamp-1", alt: "Floor lamp in living room")],
    ...
    static let mockPendantLight = Product(
        ...
        salePrice: 39.99,
        currency: "USD",
        images: [.init(url: "pendant-1", alt: "Pendant light")],
    ...
    static let mockTableLamp = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "tablelamp-1", alt: "Table lamp")],
    ...
    static let mockShowerHead = Product(
        ...
        salePrice: 69.99,
        currency: "USD",
        images: [.init(url: "shower-1", alt: "Rainfall shower head")],
    ...
    static let mockVanity = Product(
        ...
        salePrice: 449.99,
        currency: "USD",
        images: [.init(url: "vanity-1", alt: "Bathroom vanity")],
    ...
    static let mockBathTowels = Product(
        ...
        salePrice: 44.99,
        currency: "USD",
        images: [.init(url: "towels-1", alt: "Turkish towel set")],
    ...
    static let mockCurtains = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "curtain-1", alt: "Blackout curtains")],
    ...
    static let mockWallArt = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "art-1", alt: "Abstract canvas wall art")],
    ...
    static let mockMirror = Product(
        ...
        salePrice: 79.99,
        currency: "USD",
        images: [.init(url: "mirror-1", alt: "Arched floor mirror")],
    ...
    static let mockThrowPillows = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "pillows-1", alt: "Velvet pillow covers")],
    ...
    static let mockPlanters = Product(
        ...
        salePrice: 27.99,
        currency: "USD",
        images: [.init(url: "planter-1", alt: "Ceramic plant pots")],
    ...
    static let mockPatioSet = Product(
        ...
        salePrice: 349.99,
        currency: "USD",
        images: [.init(url: "patio-1", alt: "Patio conversation set")],
    ...
    static let mockStringLights = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "stringlights-1", alt: "Outdoor string lights")],
    ...
    static let mockThrowBlanket = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "blanket-1", alt: "Cozy throw blanket")],
    ...
    static let mockSheetSet = Product(
        ...
        salePrice: 29.99,
        currency: "USD",
        images: [.init(url: "sheets-1", alt: "Sheet set")],
    ...
    static let mockAreaRug = Product(
        ...
        salePrice: 129.99,
        currency: "USD",
        images: [.init(url: "rug-1", alt: "Moroccan area rug")],
    ...
    static let mockRunnerRug = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "runner-1", alt: "Runner rug")],
    ...
    static let mockKitchenFaucet = Product(
        ...
        salePrice: 329.99,
        currency: "USD",
        images: [.init(url: "faucet-1", alt: "Kitchen faucet")],
    ...
    static let mockKnifeSet = Product(
        ...
        salePrice: 149.99,
        currency: "USD",
        images: [.init(url: "knives-1", alt: "Knife block set")],
    ...
    static let mockMixerStand = Product(
        ...
        salePrice: nil,
        currency: "USD",
        images: [.init(url: "mixer-1", alt: "Stand mixer")],
    ...
    static let mockSmartPlug = Product(
        ...
        salePrice: 22.99,
        currency: "USD",
        images: [.init(url: "plug-1", alt: "Smart plug set")],
    ...
    static let mockSmartThermostat = Product(
        ...
        salePrice: 219.99,
        currency: "USD",
        images: [.init(url: "thermostat-1", alt: "Smart thermostat")],
    ...
    static let mockStorageBins = Product(
        ...
        salePrice: 34.99,
        currency: "USD",
        images: [.init(url: "bins-1", alt: "Storage bins")],
